    ...
    ui(new Ui::MainWindow)
{
    ...
    QObject::connect(this, SIGNAL(emitupdateValues()),this, SLOT(updateLblValues()));
...
void MainWindow::centerMap(QPointF pos)
{
    ...
    {
        setHeading((int)(-1 * (360 - m_GpsItems.oldbearing)));
        setHeading((int)(360 - m_GpsItems.bearing));
    }
}
...
void MainWindow::updateLblValues()
{
...
void MainWindow::parseNMEA(QString value)
{
    ...
    foreach(QString line, lines)
    {
        ...
        else if(fields[0].contains(rmcRegExp))
        {
            ...
            m_GpsItems.bearing = fields[8].toInt();
        }
